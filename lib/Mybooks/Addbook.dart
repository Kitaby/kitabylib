      ...
      width: _mediaQueryWidth/2,
       ...
       child: Column(
        ...
        children: [
           ...
           WidgetsModels.Container_widget(300,null,null,EdgeInsets.only(bottom: 20),null,Text('Enter the code in the back of the book Or search it on google ! ',style: GoogleFonts.montserrat(color: ColorPalette.SH_Grey900,fontWeight:FontWeight.w600,fontSize: 16.5 ),textAlign: TextAlign.center,)),
           
           Column(
             children: [
               WidgetsModels.Container_widget(null,null,Alignment.centerLeft,EdgeInsets.symmetric(horizontal: 30,vertical:5),null,Text('ISBN',style: GoogleFonts.montserrat(color: ColorPalette.SH_Grey900,fontWeight:FontWeight.w600,fontSize: 10 ),textAlign: TextAlign.center,)),
               Padding(
