    ...
    return Dialog(
      child: Container(
        ...
        height: _list.isEmpty
            ? _mediaQueryHeight * (2 / 3)
            : _mediaQueryHeight * (3 / 4),
                                ...
                                children: [
                                  Row(
                                    children: [
                                      SvgPicture.asset(
                                        Path.ExcelLogo,
                                        height: _mediaQueryHeight / 40,
                                      ), // Excel icon

                                      Padding(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: _mediaQueryWidth / 100),
                                        child: Text(
                                          _list[index].name,
                                          style: GoogleFonts.montserrat(
                                              color: ColorPalette.SH_Grey900,
