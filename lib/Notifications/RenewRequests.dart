                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      WidgetsModels.Container_widget(_mediaQueryWidth/1.6,_mediaQueryWidth*(1/10), Alignment.center,const EdgeInsets.only(bottom: 15 ), null, Text("Hello dear libririan , “User’s Name” sent you a loan renew request for this book “Book name”, Please answer him and thanks for your understanding !" , style: GoogleFonts.montserrat(color: ColorPalette.SH_Grey900 , fontSize: 18 , fontWeight: FontWeight.w400),), ),
                                      Padding(
                                        padding: const EdgeInsets.only(right: 20),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.end,
                                          children: [
                                            WidgetsModels.button1(_mediaQueryWidth/8, 35, ColorPalette.Error, FluentIcons.calendar_cancel_16_filled, ColorPalette.SH_Grey100, "Refuse renew"),
                                            const SizedBox(width: 30,),
                                            WidgetsModels.button1(_mediaQueryWidth/8, 35, ColorPalette.Secondary_Color_Orignal, FluentIcons.people_swap_16_filled, ColorPalette.SH_Grey100, "Accept renew"),
                                          ],
                                        ),
                                      ),
                                    ],
